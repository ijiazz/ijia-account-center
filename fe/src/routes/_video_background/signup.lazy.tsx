...
import { useMessage, useThemeToken } from "@/provider/AntdProvider.tsx";
import { IjiaLogo } from "@/components/IjiaLogo.tsx";
import { api, isHttpErrorCode } from "@/request/client.ts";
import { EmailInput } from "@/components/EmailInput.tsx";
import { EmailCaptchaActionType, PassportConfig } from "@ijia/account-dto";
...
export const Route = createLazyFileRoute("/_video_background/signup")({
...
function BasicInfo(props: { passportConfig: PassportConfig }) {
  ...
  const go = () => {
    const redirectPath = search["redirect"] || ROUTES.SignupRedirect;
